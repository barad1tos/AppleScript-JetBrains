...
class PsiGetterJvmSignatureTest {
     ...
     * synthesized JVM names (`getX`/`isX`/`setX`) MUST still resolve — if a
    ...
    fun everyConvertedGetterIsCallableFromJavaUnderExpectedName() {
        FROZEN_GETTERS.forEach { (iface, signatures) ->
            for (signature in signatures) {
                ...
                val params: Array<Class<*>> = if (paramsRaw.isEmpty()) {
                    emptyArray()
                } else {
    ...
    companion object {
         ...
         * var accessType).
         */
        private val FROZEN_GETTERS: Map<Class<*>, List<String>> = mapOf(
            AppleScriptPropertyDefinition::class.java to listOf(
            ...
            CommandParameter::class.java to listOf(
            ...
            AppleScriptCommand::class.java to listOf(
            ...
            AppleScriptClass::class.java to listOf(
            ...
            DictionaryComponent::class.java to listOf(
            ...
            ApplicationDictionary::class.java to listOf(
