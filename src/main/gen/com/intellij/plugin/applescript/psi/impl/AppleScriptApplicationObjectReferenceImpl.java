...
public class AppleScriptApplicationObjectReferenceImpl extends AbstractApplicationObjectReference implements AppleScriptApplicationObjectReference {

  public AppleScriptApplicationObjectReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AppleScriptVisitor visitor) {
    visitor.visitApplicationObjectReference(this);
  }
