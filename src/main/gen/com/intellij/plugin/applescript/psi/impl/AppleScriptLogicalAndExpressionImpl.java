...
public class AppleScriptLogicalAndExpressionImpl extends AppleScriptExpressionImpl implements AppleScriptLogicalAndExpression {

  public AppleScriptLogicalAndExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
