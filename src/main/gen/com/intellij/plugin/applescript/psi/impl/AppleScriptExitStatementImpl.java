...
public class AppleScriptExitStatementImpl extends AppleScriptPsiElementImpl implements AppleScriptExitStatement {

  public AppleScriptExitStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
