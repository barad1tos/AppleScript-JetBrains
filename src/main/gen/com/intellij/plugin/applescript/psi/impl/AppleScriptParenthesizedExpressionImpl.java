...
public class AppleScriptParenthesizedExpressionImpl extends AppleScriptExpressionImpl implements AppleScriptParenthesizedExpression {

  public AppleScriptParenthesizedExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
