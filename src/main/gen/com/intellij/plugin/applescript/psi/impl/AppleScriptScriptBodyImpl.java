...
public class AppleScriptScriptBodyImpl extends AppleScriptPsiElementImpl implements AppleScriptScriptBody {

  public AppleScriptScriptBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
