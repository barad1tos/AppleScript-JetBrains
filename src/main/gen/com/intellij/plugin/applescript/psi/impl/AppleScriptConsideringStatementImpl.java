...
public class AppleScriptConsideringStatementImpl extends AppleScriptPsiElementImpl implements AppleScriptConsideringStatement {

  public AppleScriptConsideringStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AppleScriptVisitor visitor) {
    visitor.visitConsideringStatement(this);
  }
