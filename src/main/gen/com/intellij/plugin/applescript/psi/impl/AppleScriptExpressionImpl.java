...
public class AppleScriptExpressionImpl extends AppleScriptPsiElementImpl implements AppleScriptExpression {

  public AppleScriptExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
