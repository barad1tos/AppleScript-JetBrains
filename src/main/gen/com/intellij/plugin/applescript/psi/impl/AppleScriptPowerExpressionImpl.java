...
public class AppleScriptPowerExpressionImpl extends AppleScriptExpressionImpl implements AppleScriptPowerExpression {

  public AppleScriptPowerExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
