...
public class AppleScriptUserClassNameImpl extends AppleScriptReferenceElementImpl implements AppleScriptUserClassName {

  public AppleScriptUserClassNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull AppleScriptVisitor visitor) {
    visitor.visitUserClassName(this);
  }
