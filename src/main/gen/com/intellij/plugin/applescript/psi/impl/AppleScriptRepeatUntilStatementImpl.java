...
public class AppleScriptRepeatUntilStatementImpl extends AppleScriptPsiElementImpl implements AppleScriptRepeatUntilStatement {

  public AppleScriptRepeatUntilStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
