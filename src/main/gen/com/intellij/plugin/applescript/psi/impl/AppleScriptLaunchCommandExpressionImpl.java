...
public class AppleScriptLaunchCommandExpressionImpl extends AppleScriptExpressionImpl implements AppleScriptLaunchCommandExpression {

  public AppleScriptLaunchCommandExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull AppleScriptVisitor visitor) {
    visitor.visitLaunchCommandExpression(this);
  }
