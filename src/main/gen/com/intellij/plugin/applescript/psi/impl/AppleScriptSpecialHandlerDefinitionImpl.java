...
public class AppleScriptSpecialHandlerDefinitionImpl extends AppleScriptPsiElementImpl implements AppleScriptSpecialHandlerDefinition {

  public AppleScriptSpecialHandlerDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AppleScriptVisitor visitor) {
    visitor.visitSpecialHandlerDefinition(this);
  }
