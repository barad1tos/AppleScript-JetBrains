...
public class AppleScriptNegationExpressionImpl extends AppleScriptExpressionImpl implements AppleScriptNegationExpression {

  public AppleScriptNegationExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
