...
sealed interface LookupResult {
     ...
     * built-in libraries use standard readiness; real application dictionary lookups remain stale
     * until application dictionaries are ready (see `SdefIndexReadiness.isApplicationReady`).
     *
