...
class CreateAppleScriptFileAction :
    CreateFileFromTemplateAction("AppleScript File", "Creates a AppleScript file from the specified template", AppleScriptIcons.FILE),
    DumbAware {

    override fun buildDialog(project: Project, directory: PsiDirectory, builder: CreateFileFromTemplateDialog.Builder) {
        builder.setTitle("New AppleScript file")
            .addKind("AppleScript file", AppleScriptIcons.FILE, "AppleScript File.scpt")
    }

    override fun getActionName(directory: PsiDirectory?, newName: String, templateName: String?): String =
        "Create AppleScript file $newName"
}
