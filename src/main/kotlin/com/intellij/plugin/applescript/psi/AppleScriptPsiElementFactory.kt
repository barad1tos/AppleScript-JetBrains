...
object AppleScriptPsiElementFactory {
    ...
    @JvmStatic
    fun createHandlerParameterLabel(project: Project, labelName: String?): AppleScriptHandlerParameterLabel? {
        ...
        val handlerCall = file.firstChild as? AppleScriptHandlerLabeledParametersCallExpression
            ?: return null
    ...
    @JvmStatic
    fun createFile(project: Project, text: String): AppleScriptFile {
    ...
    @JvmStatic
    fun createStringLiteral(project: Project, text: String): AppleScriptStringLiteralExpression {
    ...
    @JvmStatic
    fun createIdentifierFromText(project: Project, name: String): AppleScriptIdentifier? {
