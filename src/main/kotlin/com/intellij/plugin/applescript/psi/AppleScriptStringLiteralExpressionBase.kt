...
private typealias AppleScriptStringEscaper = LiteralTextEscaper<AppleScriptStringLiteralExpressionBase>

abstract class AppleScriptStringLiteralExpressionBase(
    node: ASTNode,
) : AppleScriptExpressionImpl(node),
    PsiLanguageInjectionHost,
    AppleScriptStringLiteralExpression {
    abstract override fun getStringLiteral(): PsiElement
    ...
    class StringLiteralEscaper(
        host: AppleScriptStringLiteralExpressionBase,
    ) : AppleScriptStringEscaper(host) {
