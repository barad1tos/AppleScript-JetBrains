...
public class AppleScriptDictionaryResolveProcessor extends AppleScriptPsiScopeProcessor {
  ...
  public static final Key<Boolean> COLLECT_ALL_DECLARATIONS = new KeyWithDefaultValue<Boolean>("apple.script.resolve.state.collect.all") {
    @Override
  ...
  @Nullable
  private final DictionaryCompositeElement myElement;
  @NotNull
  private final String myElementName;
  @NotNull
  private final SortedList<AppleScriptUseStatement> mySortedUseStatements = new SortedList<>((o1, o2) -> -(o1.getTextOffset() -
      o2.getTextOffset()));
  @NotNull
  private final List<ApplicationDictionary> collectedDictionaries = new ArrayList<>();
  ...
  public List<DictionaryComponent> getFilteredResult() {
    ...
    AppleScriptProjectDictionaryService dictionaryRegistry = myProject.getService(AppleScriptProjectDictionaryService.class);
  ...
  private static void appendResultsIfNeeded(@NotNull Collection<DictionaryComponent> result,
    ...
    AppleScriptProjectDictionaryService dictionaryRegistry = project.getService(AppleScriptProjectDictionaryService.class);
  ...
  private static void collectAllComponentsFromDictionary(@Nullable ApplicationDictionary importedDict,
    ...
    if (withCocoaStdLibFiltering) {
      AppleScriptProjectDictionaryService dictionaryRegistry = importedDict.getProject().getService(AppleScriptProjectDictionaryService.class);
